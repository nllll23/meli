...
<head>
    ...
    <title>Amorcito, ¿quieres ser mi san valentín?</title>
    <style>
        body {
        ...
        button {
            ...
            cursor: pointer;
            border-radius: 5px;
            transition: all 0.3s ease; /* Agregamos una transición suave para la animación */
        }
        button:hover {
            background-color: #e74c3c;
        }
        /* Agregamos una animación para el botón "Sí" cuando se hace clic */
        #yesButton.clicked {
        ...
        #imageGrid {
            ...
            grid-gap: 10px;
            margin-top: 20px;
            width: 600px; /* Ancho total de la cuadrícula */
            margin: auto; /* Centrar la cuadrícula */
        ...
        /* Estilos para el texto "Te amo muchote" */
        #teAmoTexto {
            position: absolute;
            top: 65%;
            left: 50%;
